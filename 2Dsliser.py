...
# -----------------------
def generate_perimeters_for_polygon(poly: Polygon, num_perimeters: int, line_width: float) -> List[
...
def run_pipeline(config_path: str):
    ...
    for idx, polygon in enumerate(polygons):
        ...
        try:
            perimeters = generate_perimeters_for_polygon(polygon, num_perimeters, line_width)
        ...
        # Внутренняя область для заполнения
        try:
